...
@njit(cache=True)
def _sor_step(P, H, r_1D, d_r, d_theta, mu, omega, SOR_W, N_r, N_theta):
    """Одна итерация SOR (Gauss-Seidel с релаксацией) + кавитация."""
...
def solve_reynolds_thrust(H, mu, omega, r_1D, theta_1D,
    ...
    for iteration in range(1, max_iter + 1):
        ...
        _sor_step(P, H, r_1D, d_r, d_theta, mu, omega, SOR_W, N_r, N_theta)
