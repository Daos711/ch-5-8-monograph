...
ax.plot(phi_1D, P_t[Z_idx, :], 'r--', linewidth=1.5, label='С углублениями')
ax.set_xlabel('φ, рад')
ax.set_ylabel('P')
ax.legend()
ax.grid(True)
...
ax.plot(eps_arr, F_s_list, 'bo-', linewidth=1.5, markersize=5, label='Гладкий')
ax.plot(eps_arr, F_t_list, 'rs-', linewidth=1.5, markersize=5, label='С углублениями')
ax.set_xlabel('ε')
ax.set_ylabel('F, Н')
ax.legend()
ax.grid(True)
...
# График 5: μ(ε)
fig, ax = plt.subplots(figsize=(7, 5))
ax.plot(eps_arr, mu_s_list, 'bo-', linewidth=1.5, markersize=5, label='Гладкий')
ax.plot(eps_arr, mu_t_list, 'rs-', linewidth=1.5, markersize=5, label='С углублениями')
ax.set_xlabel('ε')
ax.set_ylabel('μ')
ax.legend()
ax.grid(True)
...
# График 6: Q_out(ε)
fig, ax = plt.subplots(figsize=(7, 5))
ax.plot(eps_arr, Q_s_list, 'bo-', linewidth=1.5, markersize=5, label='Гладкий')
ax.plot(eps_arr, Q_t_list, 'rs-', linewidth=1.5, markersize=5, label='С углублениями')
ax.set_xlabel('ε')
